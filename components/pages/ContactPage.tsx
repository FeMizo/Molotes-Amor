...
export const ContactPage = ({ content }: { content: ContactContent }) => {
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="space-y-12">
            <div>
              <h2 className="text-3xl font-serif font-bold text-sepia mb-8">{content.infoTitle}</h2>
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    <h4 className="font-bold text-sepia">{content.addressLabel}</h4>
                    <p className="text-sepia/70">{content.addressValue}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-12 h-12 bg-terracota/10 rounded-xl flex items-center justify-center text-terracota group-hover:bg-terracota group-hover:text-crema transition-all duration-300">
                  ...
                  <div>
                    <h4 className="font-bold text-sepia">{content.phoneLabel}</h4>
                    <p className="text-sepia/70">{content.phoneValue}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-12 h-12 bg-terracota/10 rounded-xl flex items-center justify-center text-terracota group-hover:bg-terracota group-hover:text-crema transition-all duration-300">
                  ...
                  <div>
                    <h4 className="font-bold text-sepia">{content.emailLabel}</h4>
                    <p className="text-sepia/70">{content.emailValue}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 group">
                  <div className="w-12 h-12 bg-terracota/10 rounded-xl flex items-center justify-center text-terracota group-hover:bg-terracota group-hover:text-crema transition-all duration-300">
                  ...
                  <div>
                    <h4 className="font-bold text-sepia">{content.hoursLabel}</h4>
                    <p className="text-sepia/70">{content.hoursValue}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="h-64 bg-beige-tostado/20 rounded-3xl border-2 border-dashed border-beige-tostado/40 flex items-center justify-center relative overflow-hidden group">
              ...
              <div className="relative z-10 text-center p-6">
                ...
                <p className="font-serif italic text-sepia">{content.mapTitle}</p>
          ...
          <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-beige-tostado/20">
            <h3 className="text-2xl font-serif font-bold text-sepia mb-8">{content.formTitle}</h3>
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <h4 className="text-2xl font-serif font-bold text-sepia">{content.successTitle}</h4>
                <p className="text-sepia/70">{content.successDescription}</p>
                <button
                  type="button"
